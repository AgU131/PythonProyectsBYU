""" Wind chill programm - Pablo Heredia

I added a control in selecting C or F. And I added a function that calculate from fahrenheit to celsius, 
in order to show both values if celsius is entered.
"""
...
while scale.lower() != "f" and scale.lower() != "c": # only "C" or "F" is allowed
